...
SYSTEM_PROMPT = (
    ...
    "10:00). Never invent or default the reminder date or time: both must be explicitly "
    "provided by the user, otherwise ask for the missing one. A reminder also requires "
    "a real person's/business's name and a positive rupee "
